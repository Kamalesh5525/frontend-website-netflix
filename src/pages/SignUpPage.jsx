                ...
                <div className="w-full max-w-md p-8 space-y-6 bg-black/60 rounded-lg shadow-md">
                    ...
                    <form className="space-y-4" onSubmit={handleSignup}>
                        ...
                        <div>
                            ...
                            <input type="text" className="w-full px-3 py-2 mt-1 border border-gray-700 rounded-md bg-transparent text-white focus:outline-none focus:ring" placeholder="kamalesh" id="username" value={username} onChange={(e) => setUsername(e.target.value)} />
                        </div>
